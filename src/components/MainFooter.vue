      ...
      <div class="footer--body">
        ...
        <div class="footer--nav">
          ...
          <div class="nav-menu_footer">
            <a class="nav-menu--item_footer" href="#">Home</a>
            <a class="nav-menu--item_footer" href="other_pages/process-page.html">Process</a>
            <a class="nav-menu--item_footer" href="other_pages/company-page.html">Company</a>
            <a class="nav-menu--item_footer" href="other_pages/why-us-page.html">Why us</a>
          </div>
          <div class="footer--web-info">
            <span>© 2018 — 2021 Brainway LTD</span>
            <a class="footer--privacy-policy">Privacy Policy</a>
          </div>
        </div>
      </div>
    </div>
